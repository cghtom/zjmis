        ...
        $.getJSON( httpUrl + '&serviceName=MISTABLECONFIG',
            ...
            function(data) {
                ...
                $('#commit').on('click', function() {
                    ...
                    param += "&serviceName=" + serviceName+"&INTERFACE_CODE="+$("#form-horizontal").find("input").eq(0).val();
                ...
                $('#contentBody').on('click', '.btn_edit', function(){
                    ...
                    $.post(httpUrl + "&serviceName=MISGETINTERFACEBYCODE", editParam, function(data){
                        var editDataModel;
