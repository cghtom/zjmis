        ...
        $.getJSON( httpUrl + '&serviceName=MISTABLECONFIG',
            ...
            function(data) {
                ...
                $('#commit').on('click', function() {
                    ...
                    param += "&serviceName=" + serviceName+"&ID="+$("#form-horizontal").find("input").eq(0).val();
                ...
                $('#contentBody').on('click', '.btn_edit', function(){
                    ...
                    $.post(httpUrl + "&serviceName=MISGETFORMULABYID", editParam, function(data){
                        var editDataModel;
                        ...
                        $("#form-horizontal").find("div").eq(0).hide();
